...
Windows v0.1.0 fresh deployment 为 known-bad；v0.1.1 提供受验证的 Issue #1 recovery 路径。fresh deployment 的 recovery-only / explicit beta 策略仍待决定，两者都不构成正式 Windows 安全支持承诺。Python 3.9 仅保留 compatibility 测试；建议使用 Python 3.10–3.14。
